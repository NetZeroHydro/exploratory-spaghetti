...
future_dams <- read_csv(here::here('data', 'FHReD_2015_future_dams_Zarfl_et_al_beta_version.csv')) %>% 
  clean_names()
...
# Water Basin
basin_level3 <- read_sf(here::here('data', 'hybas_as_lev03_v1c.shp')) %>% 
  clean_names()

# Rivers
asia_rivers <- read_sf(here::here('data', 'HydroRIVERS_v10_as.gdb')) %>% 
  clean_names()
