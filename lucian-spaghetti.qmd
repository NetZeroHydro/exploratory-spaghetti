...
# Ensure CRS match
box_poly <- st_transform(box_poly, crs = st_crs(nepal_basin))
nepal_rivers_3up <- st_transform(nepal_rivers_3up, crs = st_crs(nepal_basin))
nepal_current_dams <- st_transform(nepal_current_dams, crs = st_crs(nepal_basin))
nepal_future_dams <- st_transform(nepal_future_dams, crs = st_crs(nepal_basin))
